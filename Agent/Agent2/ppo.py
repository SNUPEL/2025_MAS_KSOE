...
from Agent.Agent2.network import BAScheduler
...
class Agent2:
    def __init__(self, meta_data,  # 그래프 구조에 대한 정보
        ...
        self.network = BAScheduler(meta_data=meta_data,
    ...
    def get_action(self,
        ...
        self.network.eval()
        with torch.no_grad():
            action, log_prob, value, probs = self.network.act(graph_feature=state.graph_feature,
